...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/BigCatMr/A"
  ...
  s.source       = { :git => "https://github.com/BigCatMr/A.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A/Source/**/*.{h,m,swift}","A/Extension/*.{h,m,swift}"
